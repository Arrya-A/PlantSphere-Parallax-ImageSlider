...
import careTipImg from '../assets/caretip.png'

const Caretip = () => {

  return (
    <>
      <section className='container p-5 caretip d-flex justify-content-center align-items-center'>
        <div className="caretip mx-3 mx-md-5 p-md-5">
          <div className="container">
            <div className="row ps-3 ps-md-5 shadow rounded" id="tip_card" style={{ backgroundColor: 'rgb(250, 230, 194)' }}>
              <div className="col-md-6 mt-3 mt-md-0">
                <img className="caretip_image img-fluid" src={careTipImg} alt="" />
              </div>
