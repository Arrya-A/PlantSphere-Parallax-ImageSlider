  ...
  return (
    <><div className='row w-100 p-5 '>
      <div className="col-md-4">
        <h4 className='text-success mb-4 fw-bold'>PlantSphere</h4>
      ...
      <div className="col-md-2 d-md-flex justify-content-center">
        <div>
          <h4 className='mb-4 text-success fw-bold'>Quick Links</h4>
      ...
      <div className="col-md-2">
        <h4 className='mb-4 text-success fw-bold'>Guides</h4>
        <div>
          <p>FAQs</p>
